<template>
    <v-container>
        <v-row>
            <v-col>
                <material-form :materialId="materialId"></material-form>
            </v-col>
            <v-col>
                <material-list ref="materialListRef" class="material-list-style"></material-list>
            </v-col>
        </v-row>
    </v-container>
...
export default class MaterialView extends Vue {
    ...
    // } as Material;
    private material : Material = {} as Material;
